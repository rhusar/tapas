...
public class ResourcesViewImpl extends ResizeComposite implements ResourcesView {
      ...
      */
      ...
      Column<Resource, Number> assignedP1Col = new Column<Resource, Number>(daysNumberCell) {
         ...
         public Number getValue(Resource resource) {
            ResourceAllocationStatsEntry rad = client.getResourceData().get(resource.getId());
            if (rad == null) {
               return null;
            } else {
   ...
   public void bind() {
      ...
      service.tallyResourceStatsForProject(client.getProjectId(), new AsyncCallback<Map<Long, ResourceAllocationStatsEntry>>() {
         ...
         @Override
         public void onSuccess(Map<Long, ResourceAllocationStatsEntry> result) {

 ...
 */
public class TextareaTextCell extends AbstractEditableCell<String, TextareaTextCell.ViewData> {
   ...
   interface Template extends SafeHtmlTemplates {
      ...
      // CHANGED
      @Template("<textarea type=\"text\" value=\"{0}\" tabindex=\"-1\" size=\"{1}\"></input>")
    ...
    */
   public TextareaTextCell(int size) {
    ...
    */
   public TextareaTextCell(SafeHtmlRenderer<String> renderer, int size) {

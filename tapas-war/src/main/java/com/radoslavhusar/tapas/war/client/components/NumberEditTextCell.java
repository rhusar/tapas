 ...
 */
public class NumberEditTextCell extends AbstractEditableCell<String, NumberEditTextCell.ViewData> {

   interface Template extends SafeHtmlTemplates {

      // CHANGED
      @Template("<input type=\"text\" value=\"{0}\" tabindex=\"-1\" size=\"3\"></input>")
    ...
    */
   public NumberEditTextCell(SafeHtmlRenderer<String> renderer) {
